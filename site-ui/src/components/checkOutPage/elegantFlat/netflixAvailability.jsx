      ...
      <div className='main_availability'>
        ...
        <div className='checkAvailability_box'>
          <div className='checkAvailability_box_p'>
            <p>
              When would you like to stay at Three Bed Attached Bath Netflix
              Wifi Smart TV Parking WFH Desk?
            </p>
          </div>
...
export default NetflixAvailability
