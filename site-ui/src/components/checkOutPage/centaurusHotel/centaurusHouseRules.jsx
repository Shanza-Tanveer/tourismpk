    ...
    <>
      <div className='house_rules'>
        <div className='top_house_box'>
          ...
          <div>
            <p>
              Upscale peaceful Penthouse 2king/BR isb view E11 takes special
        ...
        <div className='bottom_house_box'>
          ...
          <div className='beds_box'>
            ...
            <div>
              ...
              <p>Children over 5 are welcome.</p>
              <p>
...
export default CentaurusHouseRules
