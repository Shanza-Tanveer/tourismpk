      ...
      <div className='main_availability'>
        ...
        <div className='checkAvailability_box'>
          <div className='checkAvailability_box_p'>
            <p>
              When would you like to stay at Luxury Executive 2Bedroom apartment
              Convenient and Nice Location?
            </p>
          </div>
...
export default LuxuryAvailability
