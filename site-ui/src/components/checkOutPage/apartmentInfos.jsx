...
// import ApartmentInfoData from './apartmentInfoData'
...
const ApartmentInfos = () => {
  ...
  useEffect(() => {
    fetch('https://run.mocky.io/v3/d777545f-fbb0-4a89-91aa-d2a26bf37040').then(
      (result) => {
  ...
  return (
    <>
      {/* {ApartmentInfoData.map((infoData) => {
        return <ApartmentInfo key={infoData.id} {...infoData}></ApartmentInfo>
      })} */}
